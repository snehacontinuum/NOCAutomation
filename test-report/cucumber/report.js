$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("DemoSprint/NOCTicket.feature");
formatter.feature({
...
formatter.step({
  "name": "User is able to create ticket in NOC portal for \"PSADTTM6\", \"PSADTM6-site1\",\"VOREX2\" with status in \"\u003cDatasheet\u003e\"",
  "keyword": "When ",
  "line": 9,
  "matchedColumns": [
    0,
